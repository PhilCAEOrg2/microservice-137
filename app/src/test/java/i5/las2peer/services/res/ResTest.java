...
public class ResTest {
  ...
  /**
   * 
   * Second Test for the Success_ID203074 method.
   * 
   */
  @Test
  public void testSuccess_ID203074() {
...
""");
      ...
      Assert.assertEquals("[510200]", result.getHttpCode(), 200);
  ...
  /**
   * 
   * Second Test for the Fails_ID985343 method.
   * 
   */
  @Test
  public void testFails_ID985343() {
    MiniClient c = new MiniClient();
    c.setConnectorEndpoint(connector.getHttpEndpoint());
...
""");
      ...
      Assert.assertEquals("[65897]", result.getHttpCode(), 200);
...
""");
      ...
      Assert.assertEquals("[893565]", result.getHttpCode(), 200);
